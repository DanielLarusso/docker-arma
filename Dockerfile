...
ENV ENV_STEAM_ACCOUNT_USER ${STEAM_ACCOUNT_USER}
ENV ENV_STEAM_ACCOUNT_PASSWORD ${STEAM_ACCOUNT_PASSWORD}
ENV ENV_ARMA3SERVER_DIR ${ARMA3SERVER_DIR}
ENV ENV_ARMA3SERVER_APP_ID ${ARMA3SERVER_APP_ID}
ENV ENV_ARMA3SERVER_BINARY ${ARMA3SERVER_BINARY}
